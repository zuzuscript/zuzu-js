...
- `lib/browser-*.js` and `bin/zuzu-build-browser-bundle` produce browser assets.
- `sbin/build-browser-download` packages the already-built browser assets into
  ...
  `bin/zuzu-build-browser-bundle` first when the browser bundle source has changed.
